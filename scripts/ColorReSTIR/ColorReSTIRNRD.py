...
def render_graph_ColorReSTIRNRD():
    ...
    g.create_pass('ColorReSTIR', 'ColorReSTIR', {'gOutputMode': 'Combined', 'gCandidateCount': 5, 'gCandidatesVisibility': False, 'gMaxConfidence': 20, 'gTemporalReuse': True, 'SPATIAL_REUSE': 1, 'gMaxSpatialSearch': 10, 'gSpatialRadius': 20, 'maxBounces': 3, 'computeDirect': True, 'useImportanceSampling': True})
