...
def render_graph_Reference():
    ...
    g.create_pass('ColorReSTIR', 'ColorReSTIR', {'maxBounces': 3, 'computeDirect': True, 'useImportanceSampling': True, 'gCandidateCount': 5, 'gCandidatesVisibility': False, 'gMaxConfidence': 20, 'gTemporalReuse': True, 'SPATIAL_REUSE': 1, 'gMaxSpatialSearch': 10, 'gSpatialRadius': 20, 'gChannelReuse': True})
    ...
    g.create_pass('AccumulatePass0', 'AccumulatePass', {'enabled': True, 'outputSize': 'Default', 'autoReset': False, 'precisionMode': 'Single', 'maxFrameCount': 0, 'overflowMode': 'Stop'})
