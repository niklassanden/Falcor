...
def render_graph_ColorReSTIRSVGF():
    ...
    g.add_edge('SVGFPass.Filtered image', 'ModulateIllumination.diffuseRadiance')
    g.add_edge('GBufferRT.emissive', 'SVGFPass.Emission')
    g.add_edge('ColorReSTIR.colorHit', 'Composite.B')
    g.add_edge('GBufferRT.emissive', 'Composite.A')
    g.add_edge('Composite.out', 'SVGFPass.Color')
